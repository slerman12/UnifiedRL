...
Install your preferred Pytorch with CUDA from: https://pytorch.org/get-started/locally/.
...
Extract and move downloaded MuJoCo folder into ```~/.mujoco```. For linux X86_64 architecture, this looks like:
